...
test("wallet system centers the queried wallet STAR and renders observed token PLANETS",()=>{
  const index:WalletActivityIndex={schemaVersion:"wallet-token-index-v2",wallet,addressKind:"solana",tokenCount:1,tokens:[{chainKey:"solana",mint,eventCount:9,tradeCount:4,firstEvent:100,lastEvent:500,observedTokenFlow:42,maxConfidence:.9}],coverage:null,disclosure:"test evidence"};
