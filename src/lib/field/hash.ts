...
export function deviceBudget() {
  ...
  if (reduced || saveData || memory < 4) return { field: 1800, organism: 288000, dpr: 1 };
  if (memory >= 8) return { field: 4200, organism: 660000, dpr: 1.5 };
  return { field: 2800, organism: 450000, dpr: 1.25 };
}
