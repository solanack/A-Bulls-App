...
export const DOCK: { id: FieldMode; label: string }[] = [
  { id: "explore", label: "FIELD" }, { id: "intelligence", label: "INTELLIGENCE" }, { id: "query", label: "QUERY" }, { id: "trickster", label: "CREATE" }, { id: "games", label: "GAMES" },
];
export const ANALYSIS_MODES: { id: FieldMode; label: string }[] = [
  { id: "replay", label: "REPLAY" }, { id: "evidence", label: "EVIDENCE" }, { id: "compare", label: "COMPARE" }, { id: "what-if", label: "WHAT-IF" }, { id: "sequences", label: "SEQUENCES" }, { id: "ghost", label: "GHOST" },
];
