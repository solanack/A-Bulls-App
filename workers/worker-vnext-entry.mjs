...
import {
  ...
  handleIntelligenceScheduled,
} from "./intelligence-worker-hooks.mjs";
import { guardIntelligenceRequest } from "./intelligence-request-guard.mjs";

function allowedOrigins(env = {}) {
  return String(
    env.ALLOWED_ORIGINS ||
      "https://abullsapp.com,https://www.abullsapp.com,http://localhost:8788,http://localhost:4173,http://127.0.0.1:4173",
  )
    .split(",")
