...
const ROUTES = Object.freeze({
  ...
  'GET /api/intelligence/capabilities': Object.freeze({ group: 'intelligence', access: 'public', rate: 40, handle: ({ env, cors }) => intelligenceCapabilitiesRoute(env, cors) }),
  'POST /api/intelligence/wallet-summary': Object.freeze({ group: 'intelligence', access: 'public', rate: 24, handle: ({ request, env, cors }) => intelligenceWalletSummary(request, env, cors) }),
  'POST /api/intelligence/time-machine': Object.freeze({ group: 'intelligence', access: 'public', rate: 18, handle: ({ request, env, cors }) => intelligenceTimeMachine(request, env, cors) }),
  'POST /api/intelligence/timeline': Object.freeze({ group: 'intelligence', access: 'public', rate: 18, handle: ({ request, env, cors }) => intelligenceTimeline(request, env, cors) }),
  'POST /api/intelligence/parallel-universe': Object.freeze({ group: 'intelligence', access: 'public', rate: 12, handle: ({ request, env, cors }) => intelligenceParallelUniverse(request, env, cors) }),
  'GET /api/intelligence/radar': Object.freeze({ group: 'intelligence', access: 'public', rate: 30, handle: ({ env, cors }) => intelligenceRadar(env, cors) }),
  'GET /api/intelligence/weather': Object.freeze({ group: 'intelligence', access: 'public', rate: 30, handle: ({ env, cors }) => intelligenceWeather(env, cors) }),
  'POST /api/intelligence/nft-memory': Object.freeze({ group: 'intelligence', access: 'public', rate: 18, handle: ({ request, env, cors }) => intelligenceNftMemory(request, env, cors) }),
  'GET /api/intelligence/mesh-status': Object.freeze({ group: 'intelligence', access: 'public', rate: 40, handle: ({ env, cors }) => intelligenceMeshStatus(env, cors) }),
  'GET /api/intelligence/source-health': Object.freeze({ group: 'intelligence', access: 'public', rate: 30, handle: ({ env, cors }) => intelligenceSourceHealth(env, cors) }),
  'POST /api/intelligence/index-coverage': Object.freeze({ group: 'intelligence', access: 'public', rate: 30, handle: ({ request, env, cors }) => intelligenceIndexCoverage(request, env, cors) }),
  'POST /api/intelligence/history/queue': Object.freeze({ group: 'intelligence', access: 'public', rate: 12, handle: ({ request, env, cors }) => intelligenceHistoryQueue(request, env, cors) }),
  'POST /api/intelligence/history/pass': Object.freeze({ group: 'intelligence', access: 'public', rate: 8, handle: ({ request, env, cors }) => intelligenceHistoryPassRoute(request, env, cors) }),
  'POST /api/intelligence/wallet-dna': Object.freeze({ group: 'intelligence', access: 'public', rate: 20, handle: ({ request, env, cors }) => intelligenceWalletDna(request, env, cors) }),
  'POST /api/intelligence/museum': Object.freeze({ group: 'intelligence', access: 'public', rate: 18, handle: ({ request, env, cors }) => intelligenceMuseum(request, env, cors) }),
  'POST /api/intelligence/constellation': Object.freeze({ group: 'intelligence', access: 'public', rate: 18, handle: ({ request, env, cors }) => intelligenceConstellation(request, env, cors) }),
  'POST /api/intelligence/chain-lens': Object.freeze({ group: 'intelligence', access: 'public', rate: 18, handle: ({ request, env, cors }) => intelligenceChainLens(request, env, cors) }),
  'POST /api/intelligence/candles': Object.freeze({ group: 'intelligence', access: 'public', rate: 20, handle: ({ request, env, cors }) => intelligenceCandles(request, env, cors) }),
  'POST /api/intelligence/ghost-portfolio': Object.freeze({ group: 'intelligence', access: 'public', rate: 10, handle: ({ request, env, cors }) => intelligenceGhostPortfolio(request, env, cors) }),
  'POST /api/intelligence/wallet-rivalry': Object.freeze({ group: 'intelligence', access: 'public', rate: 12, handle: ({ request, env, cors }) => intelligenceWalletRivalry(request, env, cors) }),
  'GET /api/intelligence/chain-radar': Object.freeze({ group: 'intelligence', access: 'public', rate: 30, handle: ({ env, cors }) => intelligenceChainRadar(env, cors) }),
  'GET /api/intelligence/chain-weather': Object.freeze({ group: 'intelligence', access: 'public', rate: 30, handle: ({ env, cors }) => intelligenceChainWeather(env, cors) }),
  'GET /api/intelligence/community-integrations': Object.freeze({ group: 'intelligence', access: 'public', rate: 30, handle: ({ env, cors }) => intelligenceCommunityIntegrations(env, cors) }),
  'GET /api/bull-vision': Object.freeze({ group: 'bull-vision', access: 'public', rate: 12, handle: ({ url, env, cors }) => bullVisionLite(url, env, cors) }),
  'GET /api/bull-vision/compare': Object.freeze({ group: 'bull-vision', access: 'public', rate: 8, handle: ({ url, env, cors }) => bullVisionCompareLite(url, env, cors) }),
  'GET /api/bull-vision/what-if': Object.freeze({ group: 'bull-vision', access: 'public', rate: 8, handle: ({ url, env, cors }) => bullVisionWhatIfLite(url, env, cors) }),
  'GET /api/bull-vision/life-signals': Object.freeze({ group: 'bull-vision', access: 'public', rate: 12, handle: ({ url, env, cors }) => bullVisionLifeSignalsLite(url, env, cors) }),
  'GET /bull-vision/replay': Object.freeze({ group: 'bull-vision', access: 'public', rate: 12, handle: ({ cors }) => bullVisionReplayLite(cors) })
});
  ...
  async scheduled(event, env, ctx) {
    ctx.waitUntil((async () => {
      ...
      try {
        ...
        if (db && intelligenceIndexEnabled(env)) {
          await refreshObservedIntelligenceAggregates(db);
          await db.prepare(`DELETE FROM bull_radar_anomalies WHERE expires_at IS NOT NULL AND expires_at <= unixepoch()`).run().catch(() => null);
        }
      } catch (error) { logFailure('scheduled intelligence refresh', error); }
      try {
        if (intelligenceMeshEnabled(env)) await continueIntelligenceHistoryJobs(env, 2);
      } catch (error) { logFailure('scheduled intelligence history', error); }
    })());
  }
};
