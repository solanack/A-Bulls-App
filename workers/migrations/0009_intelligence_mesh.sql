-- A Bulls App — Intelligence Mesh v1
...
CREATE INDEX IF NOT EXISTS idx_intelligence_event_provenance_wallet_slot ON intelligence_event_provenance(wallet, slot DESC);
