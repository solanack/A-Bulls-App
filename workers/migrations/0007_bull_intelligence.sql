-- A Bulls App v8.1.0 — Bull Intelligence observed-index foundation.
-- Read-only product data derived from public-chain observations already requested by the app.
...
-- Membership table prevents cohort counts from being overwritten when different
-- public wallets are analyzed at different times.
