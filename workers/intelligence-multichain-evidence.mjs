...
export function fomoTradeToChainEvents(row={}){
  ...
  const entryTx=candidateTransactionId(chain,row.entry_tx_id??row.entryTxId),exitTx=candidateTransactionId(chain,row.exit_tx_id??row.exitTxId??row.tx_id??(closed?tradeId:null)),events=[
