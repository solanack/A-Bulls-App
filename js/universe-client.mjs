...
export class UniverseClient{
  ...
  async patterns({universeId=this.#universeId,windowSeconds=86400,limit=20000}={}){const url=new URL('/api/intelligence/universe-patterns',this.#baseUrl);url.searchParams.set('universe',String(universeId));url.searchParams.set('window',String(windowSeconds));url.searchParams.set('limit',String(limit));return (await readJson(this.#fetch,url)).analysis;}
