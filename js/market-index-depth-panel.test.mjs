...
test('labels scheduled retries without claiming completion',()=>{
  const view=describeIndexJobProgress({schedulerEnabled:true,found:2,complete:0,running:0,queued:2,retrying:1,pagesCompleted:1,signaturesSeen:25,transactionsIngested:20,sources:['configured-rpc-fallback-1']});
...
test('offers reload only when every found job is complete',()=>{
  const view=describeIndexJobProgress({schedulerEnabled:true,found:2,complete:2,running:0,queued:0,retrying:0,pagesCompleted:4,signaturesSeen:100,transactionsIngested:82,sources:['configured-rpc']});
...
test('reports a paused scheduler as terminal without reload',()=>{
  const view=describeIndexJobProgress({schedulerEnabled:false,found:2,complete:0,running:0,queued:2,retrying:0,pagesCompleted:0,signaturesSeen:0,transactionsIngested:0,sources:[]});
