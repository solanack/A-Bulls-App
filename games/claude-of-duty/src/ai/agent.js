...
export class Agent {
  constructor(ai, opts = {}) {
    ...
    this.alive = true;
    this.boss = !!opts.boss;
    this.dropKind = opts.dropKind ?? null;
    this.name = opts.name ?? (this.boss ? 'COMMANDER' : `HOSTILE ${this.id}`);
    ...
    this.viewRange = this.boss ? 78 : 58;
    ...
    this.spread = 0.032;
    this.weaponDamage = opts.weaponDamage ?? (this.boss ? 34 : 17);
