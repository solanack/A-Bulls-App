 ...
 *  type      Manrope utility text plus Sora display numerals, tabular figures,
 *            and the shared Dusk Atelier semantic palette.
...
.ow-hud {
  ...
  --ink:   rgba(243,241,244,.96);
  --ink-2: rgba(204,200,210,.68);
  --ink-3: rgba(170,167,178,.42);
  --hair:  rgba(196,175,207,.30);
  --hair-2:rgba(196,175,207,.13);
...
.ow-vitals.low .ow-vt-track > i { background: linear-gradient(to bottom, #e0b7bf, #b96f7e); }
...
.ow-plate i {
  position:absolute; left:0; top:0; bottom:0; width:100%;
  background: linear-gradient(to bottom, #c5dde4, #7faeb9);
  transform-origin: left center;
}
...
.ow-slider .knob {
  ...
  box-shadow: 0 0 calc(6px * var(--k)) rgba(196,175,207,.28);
}
.ow-slider input {
...
.ow-btn.primary:hover { background:#d8c5e1; }
.ow-menu .hint {
  margin-top: calc(var(--u) * 4); font-size: calc(9.5px * var(--k));
  letter-spacing:.2em; color: var(--ink-3);
}

/* Dusk Atelier — shared two-dimensional chrome only. Geometry and positions
   above remain unchanged so the existing control layout and muscle memory hold. */
.ow-menu {
  background:
    radial-gradient(circle at 16% 48%, rgba(196,175,207,.12), transparent 34%),
    linear-gradient(105deg, rgba(23,24,32,.94) 0%, rgba(28,29,37,.82) 52%, rgba(23,24,32,.56) 100%);
  backdrop-filter: blur(calc(10px * var(--k))) saturate(.8) brightness(.82);
}
.ow-menu-inner {
...
.ow-menu h1 {
  font-weight:600;
  letter-spacing:.08em;
  text-shadow:0 calc(2px * var(--k)) calc(8px * var(--k)) rgba(7,7,11,.62);
}
.ow-row {
...
.ow-btn,
.ow-key {
  min-height:calc(44px * var(--k));
  border-color:var(--hair);
  border-radius:calc(14px * var(--k));
  color:var(--ink);
  background:rgba(50,52,63,.86);
  box-shadow:inset 0 1px rgba(255,255,255,.055),0 calc(8px * var(--k)) calc(20px * var(--k)) rgba(7,7,11,.2);
  transition:transform 110ms ease,background-color 110ms ease,border-color 110ms ease,color 110ms ease;
}
.ow-seg button + button {
  margin-left:calc(4px * var(--k));
}
.ow-seg button:last-child {
  border-right-color:var(--hair);
}
.ow-seg button:hover,
.ow-btn:hover {
  color:var(--ink);
  border-color:rgba(196,175,207,.5);
  background:rgba(58,60,72,.94);
}
.ow-seg button:active,
.ow-btn:active {
  transform:translateY(calc(1px * var(--k))) scale(.985);
}
.ow-seg button.on,
.ow-btn.primary {
  color:#1d1820;
  border-color:rgba(235,224,240,.38);
...
.ow-slider .knob {
  border-radius:50%;
  background:var(--amber);
  box-shadow:0 0 calc(8px * var(--k)) rgba(196,175,207,.28);
}
.ow-minimap::before {
  background:rgba(41,42,52,.12);
  box-shadow:0 0 calc(16px * var(--k)) calc(6px * var(--k)) rgba(7,7,11,.08);
}
.ow-minimap canvas {
  border-radius:calc(12px * var(--k));
  box-shadow:inset 0 0 0 1px rgba(196,175,207,.2),0 calc(5px * var(--k)) calc(18px * var(--k)) rgba(7,7,11,.26);
}
.ow-kf-row {
  border-right-color:rgba(196,175,207,.35);
}
.ow-kf-row::before {
  background:rgba(28,29,37,.68);
}
.ow-kf-row.mine::before {
  background:rgba(50,45,58,.74);
}
.ow-kf-row.mine {
...
@media (pointer:coarse) {
  .ow-menu { backdrop-filter:none; }
}
@media (prefers-reduced-motion:reduce) {
  .ow-seg button,
  .ow-btn,
  .ow-key { transition-duration:.01ms; }
}
