...
export class MobileControls {
  ...
  _startScreen() {
    ...
    this.start.innerHTML = '<div class="cod-card"><small>A BULLS APP // FIELD OPS</small><h1>CLAUDE <span>OF DUTY</span></h1><p>A procedural tactical FPS built for mobile. Move with the left thumb, aim on the right, and hold FIRE to engage.</p><button class="cod-deploy">DEPLOY</button></div>';
