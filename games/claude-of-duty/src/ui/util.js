...
/** Dusk Atelier type system: Manrope utility text and Sora display numerals. */
export const FONT_STACK =
  'Manrope,"Segoe UI",Inter,system-ui,-apple-system,sans-serif';

/** Display face: the ammo count, banners, the menu title. */
export const FONT_DISPLAY =
  'Sora,Manrope,"Segoe UI",system-ui,sans-serif';
