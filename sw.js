...
const NEXT_EXPERIENCE = [
  ...
  './css/intelligence-event-inspector.css?v=2',
  ...
  ...[
    ...
    'product-adapters','universal-search','entity-resolver-client','wallet-token-index-client','intelligence-event-ledger','universe-contracts','universe-quality',
