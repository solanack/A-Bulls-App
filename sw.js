...
const CORE = [
  ...
  ...versioned([
    ...
    './js/track-formatters.js', './js/track.js', './js/life.js', './js/theme-customizer.js', './js/bull-vision.js', './js/bull-intelligence.js', './js/intelligence-core.js', './js/intelligence-lab.js', './js/intelligence-time-machine.js', './js/intelligence-radar-weather.js', './js/intelligence-where-were-you.js', './js/intelligence-constellation.js', './js/main.js'
  ]),
