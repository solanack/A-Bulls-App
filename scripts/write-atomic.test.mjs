...
test("every hand-over the og skill prints is one this script accepts", { skip: !existsSync(join(TEMPLATE_ROOT, ".grok/skills/og/SKILL.md")) && "Generator-only documentation is not part of this repository" }, () => {
