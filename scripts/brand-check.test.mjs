...
test("SKILL.md and AGENTS.md name the marker path and bound this script uses", { skip: !existsSync(join(TEMPLATE_ROOT, ".grok/skills/og/SKILL.md")) && "Generator-only documentation is not part of this repository" }, () => {
...
test("the sections that own the brand-task prohibition never affirm a wait", { skip: !existsSync(join(TEMPLATE_ROOT, ".grok/skills/og/SKILL.md")) && "Generator-only documentation is not part of this repository" }, () => {
...
test("SKILL.md tells the pass to self-check with the flag this CLI accepts", { skip: !existsSync(join(TEMPLATE_ROOT, ".grok/skills/og/SKILL.md")) && "Generator-only documentation is not part of this repository" }, () => {
